Judul Program : Pencarian Data Kehadiran Mahasiswa<br>
...
Kita masuk ke bagian defini fungsi liner search sentinel ini sekaligus kita bahas satu persatu:
...
- Kemudian, ada if __name__ == "__main__": untuk menandakan bahwa program ini berjalan secara langsung, dan
...
Kode di atas menunjukkan bahwa jika input bukan berupa huruf melainkan berupa angka ataupun gabungan dari huruf dan angka, maka program akan kembali looping sampai kondisi input berupa huruf terpenuhi dan lanjut ke fungsi berikutnya. Di sini kita masukkan nama dan ternyata nama tersebut tidak ada di list data, maka akan keluar output berupa nama yang dicari beserta keterangan bahwa Bagas tidak hadir dan tidak terdaftar dalam list data.<br>

Link YouTube: https://youtu.be/hBCU57Oo4yI?si=QOIQdKMmpqXCaYHL
